        ...
        "actions": [
            {
                ...
                "params":   [{"name": "url", "label": "URL", "type": "text", "default": "/"}],
                "template": "window.location.href = '{url}';"
            },
            {
                "id":       "nav_page",
                "label":    "Abrir Página do Projeto",
                "params":   [{"name": "page", "label": "Página", "type": "text", "default": "index.html"}],
        ...
        "actions": [
            {
                ...
                "params":   [
                    {"name": "msg",  "label": "Mensagem", "type": "text",   "default": "Olá!"},
                    {"name": "type", "label": "Tipo",     "type": "select",
                     "options": ["info","success","warning","error"], "default": "info"},
                ],
            ...
            },
            {
                "id":       "open_modal",
                "label":    "Abrir Modal",
                "params":   [{"name": "id", "label": "ID do Modal", "type": "text", "default": "myModal"}],
            ...
            },
            {
                ...
                "params":   [{"name": "id", "label": "ID do Componente", "type": "text", "default": "comp_1"}],
            ...
            },
            {
                ...
                "params":   [
                    ...
                    {"name": "visible", "label": "Visível?",  "type": "select",
            ...
            },
            {
                ...
                "params":   [
                    {"name": "id",      "label": "ID",         "type": "text",   "default": "comp_1"},
                    {"name": "enabled", "label": "Habilitado?","type": "select",
                     "options": ["true","false"], "default": "true"},
                ],
            ...
            },
            {
                ...
                "params":   [{"name": "id", "label": "ID", "type": "text", "default": "comp_1"}],
        ...
        "actions": [
            {
                ...
                "label":    "Definir Valor",
                "params":   [
                    {"name": "id",    "label": "ID do Campo", "type": "text", "default": "comp_1"},
            ...
            },
            {
                "id":       "clear_field",
                "label":    "Limpar Campo",
                "params":   [{"name": "id", "label": "ID do Campo", "type": "text", "default": "comp_1"}],
            ...
            },
            {
                ...
                "params":   [
                    {"name": "id",  "label": "ID ProgressBar", "type": "text",   "default": "comp_1"},
                    {"name": "val", "label": "Valor (0-100)",   "type": "number", "default": "50"},
                ],
        ...
        "actions": [
            {
                ...
                "label":    "Iniciar Timer",
                "params":   [
                    {"name": "id", "label": "ID do Timer",   "type": "text",   "default": "comp_1"},
                    {"name": "ms", "label": "Intervalo (ms)","type": "number", "default": "1000"},
                ],
            ...
            },
            {
                "id":       "stop_timer",
                "label":    "Parar Timer",
                "params":   [{"name": "id", "label": "ID do Timer", "type": "text", "default": "comp_1"}],
                "template": "DSB.stopTimer('{id}');"
            },
            {
                "id":       "start_countdown",
                "label":    "Iniciar Countdown",
                "params":   [{"name": "id", "label": "ID Countdown", "type": "text", "default": "comp_1"}],
        ...
        "actions": [
            {
                ...
                "label":    "Chamar API",
                "params":   [
                    {"name": "url",    "label": "URL",    "type": "text",   "default": "/api/dados"},
                    {"name": "method", "label": "Método", "type": "select",
                     "options": ["GET","POST","PUT","DELETE"], "default": "GET"},
                    {"name": "target", "label": "ID Grid/Label destino", "type": "text", "default": ""},
                ],
            ...
            },
            {
                ...
                "params":   [{"name": "id", "label": "ID da DataGrid", "type": "text", "default": "comp_1"}],
        ...
        "actions": [
            {
                ...
                "params":   [{"name": "code", "label": "Código JS", "type": "textarea",
