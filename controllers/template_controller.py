...
from models import Component, Page, db
    ...
    # ── Template 1: Formulário de Login ───────────────────────────────────────
    {
        ...
        "components": [
            ...
            # Botão entrar
            {
                ...
                "events": {
                    "onClick": "DSB.toast('Verificando credenciais...','info');"
                },
            },
            # Link esqueci senha
            {
    ...
    # ── Template 2: Dashboard com KPIs ────────────────────────────────────────
    {
        ...
        "components": [
            ...
            # Status bar
            {
                ...
                "z_index": 1,
                "properties": {
                    "text": "Sistema operacional — última atualização: agora",
            ...
            # Gráfico
            {
                ...
                "properties": {
                    ...
                    "data": [42000, 55000, 48000, 72000, 61000, 89000],
                    "color": "#4154f1",
                },
            },
            # DataGrid recentes
    ...
    # ── Template 3: Formulário CRM ────────────────────────────────────────────
    {
        ...
        "components": [
            ...
            },
            {
                ...
                "height": 2,
                "z_index": 1,
                "properties": {"color": "#e0e6f0", "thickness": 1},
            },
            # Dados pessoais
            {
                "type": "heading",
            ...
            },
            {
                ...
                "rules": [
                    {"type": "obrigatorio", "params": {"message": "Nome é obrigatório"}}
                ],
            },
            {
                "type": "textbox",
            ...
            },
            {
                ...
                "height": 40,
                "z_index": 1,
                "properties": {"label": "Data de Nascimento", "font_size": 14},
            },
            {
                "type": "combobox",
                "name": "cmbStatus",
                ...
                "properties": {
                    "label": "Status",
                    "items": ["Ativo", "Inativo", "Prospecto", "VIP"],
            ...
            },
            {
                ...
                "height": 40,
                "z_index": 1,
                "properties": {"label": "Número", "placeholder": "Nº", "font_size": 14},
            },
            {
                "type": "textbox",
                "name": "txtBairro",
            ...
            # Botões
            {
                ...
                "events": {
                    "onClick": "DSB.validateAll() && DSB.toast('Cliente salvo com sucesso!','success');"
                },
            },
            {
                "type": "button",
    ...
    # ── Template 4: Landing Page ───────────────────────────────────────────────
    {
        ...
        "components": [
            # Navbar
            {
                ...
                "properties": {
                    "brand": "MinhaMarca",
                    "links": ["Home", "Produto", "Preços", "Contato"],
                    "variant": "dark",
                    "bg": "primary",
                    "expand": "lg",
                },
            ...
            # Hero
            {
                ...
                "z_index": 1,
                "properties": {
                    "text": "Solução Inteligente para o seu Negócio",
                    "tag": "h1",
                    "font_size": 40,
                    "text_color": "#012970",
                    "bold": True,
            ...
            },
            {
                ...
                "z_index": 1,
                "properties": {
                    "text": "Automatize processos, aumente produtividade e escale com segurança. Junte-se a mais de 10.000 empresas.",
                    "font_size": 16,
                    "text_color": "#666",
                    "line_height": 1.6,
                },
            },
            {
                ...
                "events": {
                    "onClick": "DSB.toast('Redirecionando para cadastro...','info');"
                },
            },
            {
                "type": "button",
            ...
            # Imagem hero placeholder
            {
                ...
                "z_index": 1,
                "properties": {
                    "src": "https://placehold.co/400x300/e8edff/4154f1?text=Produto",
                    "alt": "Produto",
                    "object_fit": "cover",
                    "border_radius": 12,
                },
            ...
            # Cards benefícios
            {
                ...
                "properties": {
                    "title": "⚡ Rápido",
                    "body": "Configure em minutos. Sem necessidade de conhecimento técnico.",
                    "shadow": True,
                    "border_radius": 10,
                    "header_bg": "#4154f1",
                    "header_color": "#fff",
            ...
            },
            {
                ...
                "properties": {
                    "title": "🔒 Seguro",
                    "body": "Dados protegidos com criptografia de ponta a ponta.",
                    "shadow": True,
                    "border_radius": 10,
                    "header_bg": "#2eca6a",
                    "header_color": "#fff",
            ...
            },
            {
                ...
                "properties": {
                    "title": "📊 Analítico",
                    "body": "Relatórios em tempo real para decisões mais inteligentes.",
                    "shadow": True,
                    "border_radius": 10,
                    "header_bg": "#ff771d",
                    "header_color": "#fff",
            ...
            # CTA final
            {
                ...
                "z_index": 1,
                "properties": {
                    "text": "🎉 Experimente por 30 dias grátis — sem cartão de crédito!",
                    "variant": "primary",
                    "font_size": 15,
                    "dismissible": False,
                },
        ...
        "components": [
            ...
            # Tabela de tarefas
            {
                ...
                "properties": {
                    ...
                    "rows": [
                        ["API de autenticação", "Carlos M.", "15/05", "✅ Concluído"],
            ...
            # Alertas e status
            {
                ...
                "z_index": 1,
                "properties": {
                    "text": "⚠️ Prazo do módulo de relatórios expira em 3 dias!",
                    "variant": "warning",
                    "font_size": 13,
                },
            },
            {
                ...
                "z_index": 1,
                "properties": {
                    "text": "✅ Ambiente de staging atualizado com sucesso.",
                    "variant": "success",
                    "font_size": 13,
                },
            },
            ...
            },
            {
                ...
                "z_index": 1,
                "properties": {
                    "text": "Conectado — dados atualizados às 14:30",
                    "icon": "bi-wifi",
                    "bg_color": "#d1e7dd",
                    "text_color": "#0a3622",
                },
            ...
            # Tabs de visão
            {
                ...
                "z_index": 1,
                "properties": {
                    "tabs": ["Por Sprint", "Por Área", "Por Responsável"],
                    "variant": "tabs",
                },
            },
        ],
...
def apply_template(template_id: str, pgid: int):
    ...
    if not tmpl:
        return (
            jsonify(
                {"ok": False, "error": f"Template '{template_id}' não encontrado."}
            ),
            404,
        )
