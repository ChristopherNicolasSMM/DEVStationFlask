        ...
        "rules": [
            {
                ...
                "params": [
                    {
                        "name": "expression",
                        "label": "Expressão JS (use DSB.val('id'))",
                        "type": "text",
                        "default": "DSB.val('comp_1') * 1.1",
                    },
                    {
                        "name": "target_id",
                        "label": "ID do Campo Destino",
                        "type": "text",
                        "default": "comp_2",
                    },
                ],
