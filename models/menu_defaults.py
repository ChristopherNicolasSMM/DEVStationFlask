...
DEFAULT_SIDEBAR = {
    "sections": [
        {"id": "pages",      "icon": "bi-files",           "label": "Páginas",     "order": 1, "expanded": True,  "type": "pages_tree"},
        {"id": "components", "icon": "bi-grid-3x3-gap",    "label": "Componentes", "order": 2, "expanded": True,  "type": "component_palette"},
        {"id": "outline",    "icon": "bi-list-nested",     "label": "Outline",     "order": 3, "expanded": False, "type": "outline_tree"},
        {"id": "odata",      "icon": "bi-cloud-arrow-down","label": "OData",       "order": 4, "expanded": False, "type": "odata_panel"},
        {"id": "history",    "icon": "bi-clock-history",   "label": "Histórico",   "order": 5, "expanded": False, "type": "version_panel"},
    ]
}
